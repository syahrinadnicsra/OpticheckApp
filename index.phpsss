...
<body class="hold-transition login-page">
    <div class="container-fluid flex bg-sky-600 flex-col justify-center items-center text-white p-3" style="min-height: 200px;">
        <h1 class="font-weight-bold mb-2">Opticheck QR Code</h1>
        <img src="app/dist/img/logoapp.png" alt="Logo App" style="width: 100px; height: 100px; border-radius: 50%;">
        <br>
        <h5 class="text-center mt-2">"Presensi Siswa SMK Pancasila Purwodadi menggunakan QR Code"</h5>
    </div>
